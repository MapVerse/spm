...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "YolbilMobileSDK",
            url: "https://artifactory.basarsoft.com.tr/artifactory/generic-release-local/pods/yolbil/YolbilMobileSDK-SPM/2.6.9/YolbilMobileSDK.xcframework.zip",
            checksum: "c7532719af0fcaffb22682395303514f603a449145f66da0df12e7eeca5d0088"
        ),
        ...
        .binaryTarget(
            ...
            url: "https://artifactory.basarsoft.com.tr/artifactory/generic-release-local/pods/inavi/INVSensorManager/4.0.4/INVSensorManager.xcframework.zip",
            checksum: "45dcb73e443270a1f342ddb81223d4bcd3cd321055f7b0e6dd2d5e9a61a663f0"
        ),
